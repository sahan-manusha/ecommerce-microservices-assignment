...
start "Customer Service (Member 1)" cmd /k "title Customer Service (5001) && cd CustomerService && dotnet run"
...
start "Product Service (Member 3)" cmd /k "title Product Service (5003) && cd ProductService && dotnet run"
